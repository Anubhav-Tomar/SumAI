...
const steps: Step[] = [
    {
        ...
        description: 'Simply drag and drop your PDF file, or click to select the file from your device',
    },
    {
        icon: <BrainCircuit size={64} strokeWidth={1.5} />,
        label: 'AI Analysis',
        description: 'Our advanced AI algorithms will analyze your document instantly',
    },
    {
    ...
    return (
        <section className="relative overflow-hidden bg-gray-50">
            ...
            <div aria-hidden='true' className="pointer-events-none absolute inset-0 -z-10 transform-gpu overflow-hidden blur-3xl">
                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-3 max-w-6xl mx-auto relative">
                    {steps.map((step, idx) => (
                        <MotionDiv
                         initial= {{ opacity: 0, y: 50 }}
                         whileInView= {{ opacity: 1, y: 0 }}
                         transition={{ duration: 0.5, delay: idx * 0.2 }} 
                         className="relative items-stretch" key={idx}>
                            <StepItem {...step} />
                            ...
                            <MotionDiv
                             ...
                             className="hidden md:block top-1/2 -right-4 transform -tramslate-y-1/2 absolute z-10">
